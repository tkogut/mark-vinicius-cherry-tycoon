...
3. **If No In-Progress Task**: Look for the first item marked as `[ ]`.
   - **If Found**: Mark it as `[/]`, read related files, and propose an implementation plan (same as `/start`).
4. **If No Tasks Remain**: Congratulate the user and ask for further instructions from the Manager.
5. In all cases, confirm your understanding of the task before writing code.
