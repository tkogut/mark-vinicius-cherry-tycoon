...
1. Read `directives/SECURITY_DIRECTIVE_V1.md` for the full security policy.
2. Read `directives/04_security_backlog.md` for current findings and status.
3. Read `directives/01_backend_backlog.md` to identify recent Backend changes.
...
7. Update `directives/04_security_backlog.md` with new issues.
