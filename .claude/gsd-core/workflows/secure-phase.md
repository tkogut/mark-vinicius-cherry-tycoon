...
```
Agent(
  prompt="Read /home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/templates/SECURITY.md`
