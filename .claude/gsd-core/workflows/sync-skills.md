...
INSTALL_JS_GLOBAL="/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
