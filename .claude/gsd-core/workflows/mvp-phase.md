...
<required_reading>
@/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/references/user-story-template.md
@/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/references/spidr-splitting.md
@/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/references/spidr-splitting.md`. Briefly:
