...
ones). Reference: @/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/templates/spec.md.
