...
- **Global scope**: `/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/notes/`)
...
2. Glob `/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/notes/` — works in any directory
