...
<required_reading>
@/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/references/ai-frameworks.md
@/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/agents/gsd-eval-planner.md for instructions.
