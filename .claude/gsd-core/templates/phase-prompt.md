...
<!-- For checkpoint task examples and patterns, see @/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
