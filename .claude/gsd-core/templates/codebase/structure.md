...
- Usage: Reference from command with `@/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
