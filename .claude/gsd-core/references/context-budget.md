...
The keys live in `.claude/settings.json` (project) or `/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/settings.json` (global) — **not** in `.planning/config.json`:
