...
**Verification depth scales with `asvs_level`** (see @/home/tkogut/projects/mark-vinicius-cherry-tycoon/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
